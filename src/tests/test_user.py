...
class TestUserAPI(TestCase):
    ...
    def test_get_all_users(self):
        response = self.client.get("/api/v1/user/list")
        self.assertEqual(response.status_code, 200)
        # assert "query_data" in response.json()
        # assert "users" in response.json()

    def test_filter_by_first_name(self):
        response = self.client.get("/api/v1/user/list?first_name=John")
        self.assertEqual(response.status_code, 200)
        # assert "query_data" in response.json()
        # assert "users" in response.json()
    ...
    def test_filter_by_last_name(self):
        response = self.client.get("/api/v1/user/list?last_name=Doe")
        self.assertEqual(response.status_code, 200)
        # assert "query_data" in response.json()
        # assert "users" in response.json()
        # for user in response.json()["users"]:
    ...
    def test_filter_by_email(self):
        response = self.client.get("/api/v1/user/list?email=john.doe@example.com")
        self.assertEqual(response.status_code, 200)
        # assert "query_data" in response.json()
        # assert "users" in response.json()
        # for user in response.json()["users"]:
    ...
    def test_filter_by_is_active(self):
        response = self.client.get("/api/v1/user/list?is_active=true")
        self.assertEqual(response.status_code, 200)
        # assert "query_data" in response.json()
        # assert "users" in response.json()
        # for user in response.json()["users"]:
    ...
    def test_filter_by_is_approved(self):
        response = self.client.get("/api/v1/user/list?is_approved=true")
        self.assertEqual(response.status_code, 200)
        # assert "query_data" in response.json()
        # assert "users" in response.json()
        # for user in response.json()["users"]:
    ...
    def test_filter_by_created_days(self):
        response = self.client.get("/api/v1/user/list?created_days=7")
        self.assertEqual(response.status_code, 200)
        # assert "query_data" in response.json()
        # assert "users" in response.json()
        # for user in response.json()["users"]:
    ...
    def test_filter_by_updated_days(self):
        response = self.client.get("/api/v1/user/list?updated_days=7")
        self.assertEqual(response.status_code, 200)
        # assert "query_data" in response.json()
        # assert "users" in response.json()
        # for user in response.json()["users"]:
    ...
    def test_limit_offset(self):
        response = self.client.get("/api/v1/user/list?limit=10&offset=20")
        self.assertEqual(response.status_code, 200)
        # assert "query_data" in response.json()
        # assert "users" in response.json()
